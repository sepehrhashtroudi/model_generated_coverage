...
public void testParametricTypes238() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testAtomicArrayRefParameters256() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testCollections257() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testMoreSpecificType258() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testSneakySelfRefs259() throws Exception { 
...
public void testMapTypesSimple265() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testSuperTypeDetectionClass266() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testSuperTypeDetectionInterface267() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testMapTypesAdvanced268() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
