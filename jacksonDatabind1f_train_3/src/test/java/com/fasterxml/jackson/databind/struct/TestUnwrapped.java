...
public void testSimpleUnwrappingSerialize168() throws Exception { 
     assertEquals("{\"name\":\"Tatu\",\"x\":1,\"y\":2}", mapper.writeValueAsString(new Unwrapping("Tatu", 1, 2))); 
 } 


public void testDeepUnwrapping181() throws Exception { 
...
public void testDoubleUnwrapping379() throws Exception { 
