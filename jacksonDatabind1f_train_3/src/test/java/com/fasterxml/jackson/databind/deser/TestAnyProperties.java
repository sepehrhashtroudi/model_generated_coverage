...
public void testIgnored225() throws Exception { 
...
public void testSimpleTyped228() throws Exception { 
...
public void testIssue797234() throws Exception { 
     String json = MAPPER.writeValueAsString(new Bean797BaseImpl()); 
     assertEquals("{}", json); 
 } 


public void testBrokenWithDoubleAnnotations422() throws Exception { 
     try { 
