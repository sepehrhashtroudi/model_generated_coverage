...
public void testUnknownHandlingIgnoreWithHandler59() throws Exception { 
...
public void testClassWithUnknownAndIgnore60() throws Exception { 
...
public void testUnknownHandlingIgnoreWithFeature61() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testPropertyIgnoralWithClass434() throws Exception { 
     XYZWrapper2 result = MAPPER.readValue("{\"value\":{\"y\":2,\"x\":1,\"z\":3}}", XYZWrapper2.class); 
     assertEquals(1, result.value.x); 
 } 


public void testUnknownHandlingIgnoreWithHandlerAndObjectReader448() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     mapper.clearProblemHandlers(); 
...
public void testUnknownHandlingDefault555() throws Exception { 
     try { 
...
public void testPropertyIgnoralForMap583() throws Exception { 
...
public void testClassIgnoreWithMap584() throws Exception { 
