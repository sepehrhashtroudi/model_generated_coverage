...
public void testRootWrapping5() throws Exception { 
...
public void testIssue456WrapperPart117() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testJackson398123() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testInArray211() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testIncompatibleRootType312() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
@SuppressWarnings("unchecked") 
 public void testSuperClass454() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     SubType bean = new SubType(); 
