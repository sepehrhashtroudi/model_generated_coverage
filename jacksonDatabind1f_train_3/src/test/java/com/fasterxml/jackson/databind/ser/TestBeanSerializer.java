...
public void testFailWithDupProps79() throws Exception { 
...
public void testBuilderReplacement133() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyKeySerializer243() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyCollectionSerializer404() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyArraySerializer408() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyMapSerializer579() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
