...
@SuppressWarnings("unchecked") 
 public void testIssue465371() throws Exception { 
...
public void testJackson431380() throws Exception { 
     final Test431Container foo = MAPPER.readValue("{\"items\":\n" + "[{\"bar\": 0,\n" + "\"id\": \"id123\",\n" + "\"foo\": 1\n" + "}]}", Test431Container.class); 
     assertNotNull(foo); 
 } 


public void testJackson438381() throws Exception { 
     try { 
...
public void testExceptionFromConstructor382() throws Exception { 
     try { 
...
public void testIgnoredSingleArgCtor416() throws Exception { 
     try { 
...
public void testSimpleConstructor491() throws Exception { 
