...
public void testEnumsWithJsonValueUsingMixin75() throws Exception { 
...
public void testSubclassedEnums120() throws Exception { 
     assertEquals("\"B\"", mapper.writeValueAsString(EnumWithSubClass.B)); 
 } 


public void testEnumSet406() throws Exception { 
...
public void testEnumAsObjectValid409() throws Exception { 
     assertEquals("{\"value\":\"a1\"}", mapper.writeValueAsString(PoNUM.A)); 
 } 


public void testAnnotationsOnEnumCtor420() throws Exception { 
...
public void testToStringEnumWithEnumMap483() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testEnumAsIndexViaAnnotations508() throws Exception { 
     assertEquals("{\"text\":0}", mapper.writeValueAsString(new PoNUMContainer())); 
 } 


public void testEnumAsObjectBroken510() throws Exception { 
     try { 
