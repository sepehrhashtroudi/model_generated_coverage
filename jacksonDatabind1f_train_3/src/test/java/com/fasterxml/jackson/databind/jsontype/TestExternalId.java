...
public void testImproperExternalIdSerialization39() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     assertEquals("{\"extType\":\"funk\",\"i\":3}", mapper.writeValueAsString(new FunkyExternalBean())); 
 } 


public void testWithNaturalScalar11840() throws Exception { 
...
public void testMultipleTypeIdsDeserialization195() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testWithScalar118196() throws Exception { 
...
public void testExternalTypeWithCreator197() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     mapper.registerSubtypes(ValueBean.class); 
...
public void testIssue798198() throws Exception { 
