...
public void testMapNullSerialization284() throws IOException { 
...
public void testDefaultKeySerializer299() throws IOException { 
     ObjectMapper m = new ObjectMapper(); 
...
public void testMapKeyValueSerialization553() throws IOException { 
     Map<String, String> map = new HashMap<String, String>(); 
     map.put("a", "b"); 
