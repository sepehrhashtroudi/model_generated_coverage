...
public void testCustomPropertyForClass22() throws Exception { 
...
public void testAlwaysAsId23() throws Exception { 
     String json = MAPPER.writeValueAsString(new AlwaysContainer()); 
     assertEquals("{\"a\":1,\"b\":2}", json); 
 } 


public void testCustomPropertyViaProperty43() throws Exception { 
...
public void testAlwaysIdForTree192() throws Exception { 
...
public void testInvalidProp531() throws Exception { 
     try { 
