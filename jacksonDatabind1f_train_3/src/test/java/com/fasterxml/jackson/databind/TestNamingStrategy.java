...
public void testWithGetterAsSetter126() throws Exception { 
...
public void testSimpleFields154() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testJson348() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testSimpleGetters442() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     mapper.setPropertyNamingStrategy(new PrefixStrategy()); 
...
public void testPerClassAnnotation443() throws Exception { 
