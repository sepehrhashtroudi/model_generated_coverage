...
public void testCollectionType125() { 
...
public void testJavaTypeAsJLRType260() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testSimpleClass286() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
