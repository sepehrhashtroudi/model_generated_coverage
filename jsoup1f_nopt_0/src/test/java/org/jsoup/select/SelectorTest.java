...
@Test
public void combinator1() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p><p>Four</p>"); Elements ps = doc.select("p:gt(0)"); assertEquals(3, ps.size()); assertEquals("One", ps.get(0).tagName()); assertEquals("Two", ps.get(1).tagName()); assertEquals("Three", ps.get(2).tagName()); assertEquals("Four", ps.get(3).tagName()); }
@Test
...
@Test
public void findElements3() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p></div><div><p>Four</p>"); Elements ps = doc.select("p:lt(2)"); assertEquals(3, ps.size()); Elements ps2 = ps.select("p:gt(2)"); assertEquals(2, ps2.size()); assertEquals("Two", ps2.get(0).text()); assertEquals("Three", ps2.get(1).text()); assertEquals("Four", ps2.get(2).text()); }
@Test
public void findElements2() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p></div>"); Elements ps = doc.select("p:gt(0)"); assertEquals(2, ps.size()); Elements ps2 = ps.select("p:lt(0)"); assertEquals(1, ps2.size()); assertEquals("Two", ps2.get(0).text()); assertEquals("Three", ps2.get(1).text()); }
@Test
public void findElements1() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p></div><div><p>Four</p>"); Elements ps = doc.select("p:gt(0)"); assertEquals(2, ps.size()); Elements ps2 = ps.select("p:lt(0)"); assertEquals(1, ps2.size()); assertEquals("Two", ps2.get(0).text()); assertEquals("Three", ps2.get(1).text()); }
@Test
...
@Test
public void consumeIndex5() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p></div><div><p>Four</p>"); Elements ps = doc.select("p:eq(0)"); assertEquals(3, ps.size()); assertEquals("One", ps.get(0).text()); assertEquals("Four", ps.get(1).text()); assertEquals("Five", ps.get(2).text()); assertEquals("Seven", ps.get(3).text()); assertEquals("Seven", ps.get(4).text()); }
@Test
public void consumeIndex4() { Document doc = Jsoup.parse("<div><p>One</p>...<p>Two</p>...<p>Three</p>"); Elements ps = doc.select("p:eq(0)"); assertEquals(3, ps.size()); assertEquals("One", ps.get(0).text()); assertEquals("Two", ps.get(1).text()); assertEquals("Three", ps.get(2).text()); }
@Test
public void consumeIndex3() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p></div><div><p>Four</p>"); Elements ps = doc.select("p:eq(0)"); assertEquals(3, ps.size()); assertEquals("One", ps.get(0).text()); assertEquals("Two", ps.get(1).text()); assertEquals("Three", ps.get(2).text()); assertEquals("Four", ps.get(3).text()); }
@Test
public void consumeIndex2() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p></div>"); Elements ps = doc.select("p:eq(0)"); assertEquals(1, ps.size()); assertEquals("One", ps.get(0).text()); assertEquals("Two", ps.get(1).text()); assertEquals("Three", ps.get(2).text()); }
@Test
public void consumeIndex1() { Document doc = Jsoup.parse("<div><p>One</p><p>Two</p><p>Three</p></div><div><p>Four</p>"); Elements ps = doc.select("p:eq(0)"); assertEquals(1, ps.size()); assertEquals("One", ps.get(0).text()); assertEquals("Four", ps.get(1).text()); assertEquals("Five", ps.get(2).text()); assertEquals("Seven", ps.get(3).text()); assertEquals("Seven", ps.get(4).text()); }
@Test
public void filterForAdjacentSiblings1() { Document doc = Jsoup.parse("<div><span>One</span><span>Two</span><span>Three</span></div>"); Elements siblings = doc.select("span > span"); assertEquals(3, siblings.size()); assertEquals("One", siblings.get(0).text()); assertEquals("Two", siblings.get(1).text()); assertEquals("Three", siblings.get(2).text()); }
@Test
