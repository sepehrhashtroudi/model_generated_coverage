...
@Test
public void addFirst2() { TokenQueue tq = new TokenQueue("One Two Three"); tq.consumeWord(); tq.addFirst("One"); tq.consumeWord(); String data = tq.toString(); assertEquals("One Two Three", data); }
@Test
public void addFirst1() { TokenQueue tq = new TokenQueue("One Two Three"); tq.consumeWord(); tq.consumeWord(); tq.addFirst("One"); tq.addFirst("Two"); tq.consumeWord(); String data = tq.toString(); assertEquals("One Two Three", data); }
@Test
...
@Test
public void getName1() { Tag p = Tag.valueOf("p"); assertEquals("p", p.getName()); }
@Test
public void valueOf() { Tag p1 = Tag.valueOf("p"); Tag p2 = Tag.valueOf("p"); assertEquals(p1, p2); }
@Test
public void canContain1() { Tag a = Tag.valueOf("a"); Tag b = Tag.valueOf("b"); Tag c = Tag.valueOf("c"); assertFalse(a.canContain(b)); assertFalse(b.canContain(a)); assertFalse(c.canContain(b)); assertTrue(a.canContain(a)); assertTrue(b.canContain(b)); assertTrue(c.canContain(c)); }
@Test
public void canContain2() { Tag p1 = Tag.valueOf("p"); Tag p2 = Tag.valueOf("p"); Tag p3 = Tag.valueOf("p"); Tag p4 = Tag.valueOf("p"); assertFalse(p1.canContain(p2)); assertFalse(p1.canContain(p3)); assertFalse(p1.canContain(p4)); assertTrue(p1.canContain(p1)); assertTrue(p1.canContain(p2)); assertTrue(p1.canContain(p3)); assertTrue(p1.canContain(p4)); }
@Test
...
@Test
public void isData1() { Tag a = Tag.valueOf("a"); Tag b = Tag.valueOf("b"); assertTrue(a.isData()); assertTrue(b.isData()); assertFalse(a.isData()); }
@Test
