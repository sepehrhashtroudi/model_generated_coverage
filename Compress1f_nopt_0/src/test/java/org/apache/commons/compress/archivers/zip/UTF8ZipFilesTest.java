...
public void testGetHeaderId180() throws Exception { UnicodePathExtraField f = new UnicodePathExtraField(); assertEquals(new ZipShort(0x7075), f.getHeaderId()); }
public void testGetHeaderId181() throws Exception { UnicodePathExtraField instance = new UnicodePathExtraField(); ZipShort expResult = new ZipShort(0x7075); ZipShort result = instance.getHeaderId(); assertEquals(expResult, result); }
