...
public void testImproperExternalIdSerialization32() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     assertEquals("{\"extType\":\"funk\",\"i\":3}", mapper.writeValueAsString(new FunkyExternalBean())); 
 } 


public void testWithNaturalScalar11833() throws Exception { 
...
public void testMultipleTypeIdsDeserialization187() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testWithScalar118188() throws Exception { 
...
public void testIssue831189() throws Exception { 
...
public void testExternalTypeWithCreator190() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     mapper.registerSubtypes(ValueBean.class); 
...
public void testIssue798191() throws Exception { 
