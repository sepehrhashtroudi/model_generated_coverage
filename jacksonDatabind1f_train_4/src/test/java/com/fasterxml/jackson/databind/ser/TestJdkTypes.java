...
public void testBigDecimalAsPlainString205() throws Exception { 
...
public void testCurrency388() throws IOException { 
     Currency usd = Currency.getInstance("USD"); 
     assertEquals(quote("USD"), MAPPER.writeValueAsString(usd)); 
 } 


public void testClass390() throws IOException { 
...
public void testCharset392() throws IOException { 
