...
public void testIntTypeOverride460() throws Exception { 
...
public void testFpTypeOverrideStructured461() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
...
public void testFpTypeOverrideSimple538() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
     m.enable(DeserializationFeature.USE_BIG_DECIMAL_FOR_FLOATS); 
