...
public void testAtomicBoolean552() throws Exception { 
...
public void testAtomicInteger553() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testAtomicLong554() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     assertEquals("0", serializeAsString(mapper, new AtomicLong(0))); 
 } 


public void testAtomicReference555() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
