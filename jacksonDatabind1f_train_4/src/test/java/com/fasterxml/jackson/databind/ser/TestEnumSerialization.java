...
public void testEnumsWithJsonValueUsingMixin65() throws Exception { 
...
public void testSubclassedEnums106() throws Exception { 
     assertEquals("\"B\"", mapper.writeValueAsString(EnumWithSubClass.B)); 
 } 


public void testEnumAsObjectValid396() throws Exception { 
     assertEquals("{\"value\":\"a1\"}", mapper.writeValueAsString(PoNUM.A)); 
 } 


public void testAnnotationsOnEnumCtor407() throws Exception { 
...
public void testToStringEnumWithEnumMap477() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testEnumUsingToString499() throws Exception { 
...
public void testEnumAsIndexViaAnnotations501() throws Exception { 
     assertEquals("{\"text\":0}", mapper.writeValueAsString(new PoNUMContainer())); 
 } 


public void testAsIndex503() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testEnumAsObjectBroken504() throws Exception { 
     try { 
