...
public void testAppend263() throws IOException { 
...
public void testSimpleArray265() throws IOException { 
...
public void testWithJsonParserSequenceSimple266() throws IOException { 
     TokenBuffer buf = new TokenBuffer(null); 
     buf.writeStartArray(); 
...
public void testSimpleObject268() throws IOException { 
     TokenBuffer buf = new TokenBuffer(null); 
     assertTrue(buf.getOutputContext().inRoot()); 
...
public void testWithJSONSampleDoc271() throws Exception { 
