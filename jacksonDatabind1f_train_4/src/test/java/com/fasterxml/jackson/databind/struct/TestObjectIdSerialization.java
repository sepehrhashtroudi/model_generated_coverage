...
public void testCustomPropertyForClass17() throws Exception { 
...
public void testAlwaysAsId18() throws Exception { 
     String json = MAPPER.writeValueAsString(new AlwaysContainer()); 
     assertEquals("{\"a\":1,\"b\":2}", json); 
 } 


public void testCustomPropertyViaProperty36() throws Exception { 
