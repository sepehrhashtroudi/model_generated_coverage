...
public void testIssue456WrapperPart104() throws Exception { 
...
public void testJackson398108() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testInArray200() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testIncompatibleRootType305() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
