...
public void testLongArrayToX267() throws Exception { 
     long[] data = longs(); 
...
public void testIntArrayToX506() throws Exception { 
     int[] data = ints(); 
...
public void testShortArrayToX568() throws Exception { 
     short[] data = shorts(); 
