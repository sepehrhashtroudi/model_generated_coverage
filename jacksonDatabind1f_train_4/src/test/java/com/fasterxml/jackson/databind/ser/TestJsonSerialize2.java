...
public void testNullSerializer80() throws Exception { 
     String json = MAPPER.writeValueAsString(new NullBean()); 
     assertEquals("{\"value\":null}", json); 
 } 


public void testSerializedAsListWithClassAnnotations113() throws IOException { 
...
public void testSerializedAsListWithClassSerializer130() throws IOException { 
...
public void testEmptyInclusion252() throws IOException { 
...
public void testSerializedAsMapWithPropertyAnnotations280() throws IOException { 
