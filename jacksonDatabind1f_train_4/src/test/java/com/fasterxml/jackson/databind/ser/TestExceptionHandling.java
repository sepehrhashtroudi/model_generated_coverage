...
public void testCatchAndRethrow128() throws Exception { 
...
public void testExceptionWithMapperAndGenerator482() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testExceptionWithSimpleMapper511() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     try { 
         BrokenStringWriter sw = new BrokenStringWriter("TEST"); 
