...
public void testIgnored216() throws Exception { 
...
public void testSimpleTyped218() throws Exception { 
...
public void testIssue797225() throws Exception { 
     String json = MAPPER.writeValueAsString(new Bean797BaseImpl()); 
     assertEquals("{}", json); 
 } 


public void testBrokenWithDoubleAnnotations409() throws Exception { 
     try { 
