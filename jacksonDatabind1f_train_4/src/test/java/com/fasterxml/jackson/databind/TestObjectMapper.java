...
public void testCopy136() throws Exception { 
...
public void testConfigForPropertySorting294() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
...
public void testTreeRead298() throws Exception { 
     String JSON = "{ }"; 
...
public void testProviderConfig450() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
