...
@SuppressWarnings("unchecked") 
 public void testIssue465369() throws Exception { 
...
public void testJackson431372() throws Exception { 
     final Test431Container foo = MAPPER.readValue("{\"items\":\n" + "[{\"bar\": 0,\n" + "\"id\": \"id123\",\n" + "\"foo\": 1\n" + "}]}", Test431Container.class); 
     assertNotNull(foo); 
 } 


public void testJackson438374() throws Exception { 
     try { 
...
public void testExceptionFromConstructor375() throws Exception { 
     try { 
...
public void testSimpleConstructor486() throws Exception { 
...
public void testCreatorWithDupNames564() throws Exception { 
     try { 
