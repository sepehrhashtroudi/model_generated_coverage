...
public void testFromEmptyString214() throws Exception { 
...
public void testIntArray219() throws Exception { 
     final int LEN = 70000; 
...
public void testBeanArray246() throws Exception { 
...
public void testByteArraysWith763273() throws Exception { 
...
public void testLongArray329() throws Exception { 
     final int LEN = 12300; 
     StringBuilder sb = new StringBuilder(); 
     sb.append('['); 
     for (int i = 0; i < LEN; ++i) { 
...
public void testDoubleArray335() throws Exception { 
     final int LEN = 7000; 
     StringBuilder sb = new StringBuilder(); 
     sb.append('['); 
     for (int i = 0; i < LEN; ++i) { 
...
public void testByteArrayAsNumbers424() throws Exception { 
     final int LEN = 37000; 
     StringBuilder sb = new StringBuilder(); 
     sb.append('['); 
     for (int i = 0; i < LEN; ++i) { 
...
public void testCustomDeserializers488() throws Exception { 
...
public void testCharArray507() throws Exception { 
...
public void testShortArray509() throws Exception { 
     final int LEN = 31001; 
     StringBuilder sb = new StringBuilder(); 
     sb.append('['); 
     for (int i = 0; i < LEN; ++i) { 
