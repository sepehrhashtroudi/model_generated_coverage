...
public void testPropertyIgnoral358() throws Exception { 
...
public void testPropertyIgnoralWithClass425() throws Exception { 
     XYZWrapper2 result = MAPPER.readValue("{\"value\":{\"y\":2,\"x\":1,\"z\":3}}", XYZWrapper2.class); 
     assertEquals(1, result.value.x); 
 } 


public void testUnknownHandlingIgnoreWithHandlerAndObjectReader441() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testUnknownHandlingDefault550() throws Exception { 
     try { 
