...
public void testCanonicalNames153() { 
...
public void testParametricTypes229() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testMapTypesRaw248() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testCollections249() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testMoreSpecificType250() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testSneakySelfRefs251() throws Exception { 
...
public void testRawCollections254() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testMapTypesSimple256() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testSuperTypeDetectionClass257() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testSuperTypeDetectionInterface258() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
...
public void testMapTypesAdvanced259() { 
     TypeFactory tf = TypeFactory.defaultInstance(); 
