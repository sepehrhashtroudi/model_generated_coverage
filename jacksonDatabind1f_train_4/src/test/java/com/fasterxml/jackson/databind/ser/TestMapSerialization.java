...
public void testDefaultKeySerializer288() throws IOException { 
...
public void testOrderByKey303() throws IOException { 
     ObjectMapper m = new ObjectMapper(); 
...
public void testMapKeyValueSerialization548() throws IOException { 
     Map<String, String> map = new HashMap<String, String>(); 
     map.put("a", "b"); 
