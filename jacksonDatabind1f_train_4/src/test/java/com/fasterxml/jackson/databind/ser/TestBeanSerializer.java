...
public void testFailWithDupProps68() throws Exception { 
...
public void testBuilderReplacement124() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testPropertyReorder182() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyKeySerializer233() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyCollectionSerializer393() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyArraySerializer395() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyEnumSerializer397() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testModifyMapSerializer578() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
