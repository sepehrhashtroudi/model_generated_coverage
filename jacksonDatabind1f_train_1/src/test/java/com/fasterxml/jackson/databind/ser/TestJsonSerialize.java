...
@SuppressWarnings("unchecked") 
 public void testSimpleValueDefinition14() throws Exception { 
...
public void testStaticTypingWithArrayList140() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
...
public void testStaticTypingWithLinkedList396() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
     m.configure(MapperFeature.USE_STATIC_TYPING, true); 
...
public void testBrokenAnnotation421() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
     try { 
...
public void testProblem294422() throws Exception { 
     assertEquals("{\"id\":\"fooId\",\"bar\":\"barId\"}", new ObjectMapper().writeValueAsString(new Foo294("fooId", "barId"))); 
 } 


@SuppressWarnings("unchecked") 
 public void testStaticTypingForClass463() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
