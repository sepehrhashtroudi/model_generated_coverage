...
public void testSimpleEnumSerializer232() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     SimpleModule mod = new SimpleModule("test", Version.unknownVersion()); 
...
public void testMultipleModules233() throws Exception { 
...
public void testAccessToMapper277() throws Exception { 
...
public void testWithoutModule363() { 
     ObjectMapper mapper = new ObjectMapper(); 
     try { 
