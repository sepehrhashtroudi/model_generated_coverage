...
public void testByteArrayFrom38() throws Exception { 
...
public void testLongArrayToX262() throws Exception { 
     long[] data = longs(); 
...
public void testArrayIdentityTransforms266() throws Exception { 
...
public void testIntArrayToX513() throws Exception { 
     int[] data = ints(); 
...
public void testShortArrayToX569() throws Exception { 
     short[] data = shorts(); 
