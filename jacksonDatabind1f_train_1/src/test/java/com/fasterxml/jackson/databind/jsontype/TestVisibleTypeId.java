...
public void testInvalidMultipleTypeIds175() throws Exception { 
     try { 
...
public void testVisibleWithExternalId265() throws Exception { 
...
public void testTypeIdFromProperty349() throws Exception { 
     assertEquals("{\"type\":\"SomeType\",\"a\":3}", mapper.writeValueAsString(new TypeIdFromFieldProperty())); 
 } 


public void testVisibleWithWrapperObject481() throws Exception { 
