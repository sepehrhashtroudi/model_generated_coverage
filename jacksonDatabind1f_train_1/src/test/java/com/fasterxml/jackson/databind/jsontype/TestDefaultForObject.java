...
public void testFeature432141() throws Exception { 
...
public void testBeanAsObject154() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
     m.enableDefaultTyping(); 
...
public void testIssue352259() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testAbstractBean434() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
