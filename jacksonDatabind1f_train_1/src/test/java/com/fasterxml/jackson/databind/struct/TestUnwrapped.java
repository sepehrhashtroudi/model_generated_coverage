...
public void testSimpleUnwrappingSerialize157() throws Exception { 
     assertEquals("{\"name\":\"Tatu\",\"x\":1,\"y\":2}", mapper.writeValueAsString(new Unwrapping("Tatu", 1, 2))); 
 } 


public void testDeepUnwrapping169() throws Exception { 
...
public void testDeepUnwrappingSerialize183() throws Exception { 
     assertEquals("{\"name\":\"Tatu\",\"x\":1,\"y\":2}", mapper.writeValueAsString(new DeepUnwrapping("Tatu", 1, 2))); 
 } 


public void testSimpleUnwrappedDeserialize351() throws Exception { 
...
public void testDoubleUnwrapping370() throws Exception { 
...
public void testUnwrappedDeserializeWithCreator508() throws Exception { 
