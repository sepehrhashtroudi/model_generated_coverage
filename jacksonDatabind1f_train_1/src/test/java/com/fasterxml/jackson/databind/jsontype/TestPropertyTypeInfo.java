...
public void testSimpleArrayField65() throws Exception { 
...
public void testSimpleArrayMethod147() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testSimpleMapField388() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testSimpleListField467() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
