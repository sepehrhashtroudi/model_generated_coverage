...
public void testCollectionLikeDeserialization250() throws Exception { 
...
public void testMapLikeSerialization392() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     mapper.setTypeFactory(mapper.getTypeFactory().withModifier(new MyTypeModifier())); 
     mapper.registerModule(new ModifierModule()); 
...
public void testCollectionLikeSerialization394() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     mapper.setTypeFactory(mapper.getTypeFactory().withModifier(new MyTypeModifier())); 
     mapper.registerModule(new ModifierModule()); 
