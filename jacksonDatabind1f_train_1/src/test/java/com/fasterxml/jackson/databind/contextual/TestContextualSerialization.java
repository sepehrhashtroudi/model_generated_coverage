...
public void testMethodAnnotationInList124() throws Exception { 
...
public void testMethodAnnotationInArray126() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     SimpleModule module = new SimpleModule("test", Version.unknownVersion()); 
     module.addSerializer(String.class, new AnnotatedContextualSerializer()); 
     mapper.registerModule(module); 
...
public void testMethodAnnotationInMap131() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     SimpleModule module = new SimpleModule("test", Version.unknownVersion()); 
     module.addSerializer(String.class, new AnnotatedContextualSerializer()); 
     mapper.registerModule(module); 
...
public void testContextualViaAnnotation386() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
