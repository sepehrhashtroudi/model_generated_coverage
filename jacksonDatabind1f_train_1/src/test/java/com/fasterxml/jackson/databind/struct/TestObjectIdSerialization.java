...
public void testAlwaysAsId17() throws Exception { 
     String json = MAPPER.writeValueAsString(new AlwaysContainer()); 
     assertEquals("{\"a\":1,\"b\":2}", json); 
 } 


public void testCustomPropertyViaProperty34() throws Exception { 
...
public void testAlwaysIdForTree181() throws Exception { 
...
public void testInvalidProp533() throws Exception { 
     try { 
