...
public void testVisibleWithWrapperArray111() throws Exception { 
...
public void testInvalidMultipleTypeIds180() throws Exception { 
     try { 
...
public void testVisibleWithExternalId261() throws Exception { 
...
public void testTypeIdFromProperty350() throws Exception { 
     assertEquals("{\"type\":\"SomeType\",\"a\":3}", mapper.writeValueAsString(new TypeIdFromFieldProperty())); 
 } 


public void testVisibleWithWrapperObject483() throws Exception { 
