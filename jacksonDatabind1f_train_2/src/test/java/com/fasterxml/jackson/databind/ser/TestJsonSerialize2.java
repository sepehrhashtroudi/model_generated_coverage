...
public void testSerializedAsMapWithPropertyAnnotations212() throws IOException { 
...
public void testSerializedAsMapWithClassAnnotations14() throws IOException { 
...
public void testNullSerializer85() throws Exception { 
     String json = MAPPER.writeValueAsString(new NullBean()); 
     assertEquals("{\"value\":null}", json); 
 } 


public void testSerializedAsListWithClassSerializer133() throws IOException { 
...
public void testSerializedAsListWithPropertyAnnotations2134() throws IOException { 
...
public void testEmptyInclusion247() throws IOException { 
...
public void testSerializedAsMapWithPropertyAnnotations274() throws IOException { 
     MapWrapperSimple input = new MapWrapperSimple("a", "b"); 
     assertEquals("{\"values\":{\"toString:a\":{\"value\":\"b\"}}}", MAPPER.writeValueAsString(input)); 
 } 


public void testSerializedAsMapWithClassSerializer399() throws IOException { 
