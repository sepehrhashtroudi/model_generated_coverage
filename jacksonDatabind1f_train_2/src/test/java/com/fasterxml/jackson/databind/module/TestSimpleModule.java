...
public void testSimpleBeanSerializer127() throws Exception { 
...
public void testSimpleInterfaceSerializer130() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     SimpleModule mod = new SimpleModule("test", Version.unknownVersion()); 
...
public void testMixIns231() throws Exception { 
...
public void testSimpleEnumSerializer233() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     SimpleModule mod = new SimpleModule("test", Version.unknownVersion()); 
...
public void testMultipleModules234() throws Exception { 
...
public void testAccessToMapper278() throws Exception { 
...
public void testWithoutModule362() { 
     ObjectMapper mapper = new ObjectMapper(); 
     try { 
