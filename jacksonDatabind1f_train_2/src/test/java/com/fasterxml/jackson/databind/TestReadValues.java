...
public void testNonRootMapsWithObjectReader229() throws Exception { 
...
public void testRootArraysWithParser441() throws Exception { 
     final String JSON = "[1][3]"; 
     JsonParser jp = MAPPER.getFactory().createParser(JSON); 
     assertToken(JsonToken.START_ARRAY, jp.nextToken()); 
...
public void testHasNextWithEndArrayManagedParser460() throws Exception { 
     final String JSON = "[1,3]"; 
...
public void testRootBeans461() throws Exception { 
