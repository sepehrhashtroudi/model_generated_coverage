...
public void testIgnoreViaPropsAndClass187() throws Exception { 
     assertEquals("{\"value\":{\"y\":2}}", MAPPER.writeValueAsString(new WrapperWithPropIgnore2())); 
 } 


public void testExplicitIgnoralWithMap581() throws Exception { 
...
public void testIgnoreWithMapProperty582() throws Exception { 
