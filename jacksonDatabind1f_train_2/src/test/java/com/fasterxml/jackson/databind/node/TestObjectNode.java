...
public void testSetAll95() throws Exception { 
...
public void testInvalidWith99() throws Exception { 
...
public void testInvalidWithArray100() throws Exception { 
     JsonNode root = MAPPER.createArrayNode(); 
     try { 
         root.withArray("prop"); 
         fail("Expected exception"); 
...
public void testValidWith560() throws Exception { 
     ObjectNode root = MAPPER.createObjectNode(); 
...
public void testValidWithArray561() throws Exception { 
     ObjectNode root = MAPPER.createObjectNode(); 
     assertEquals("{}", MAPPER.writeValueAsString(root)); 
