...
public void testStaticTypingWithArrayList139() throws Exception { 
...
public void testBrokenAnnotation423() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
     try { 
...
public void testProblem294424() throws Exception { 
     assertEquals("{\"id\":\"fooId\",\"bar\":\"barId\"}", new ObjectMapper().writeValueAsString(new Foo294("fooId", "barId"))); 
 } 


@SuppressWarnings("unchecked") 
 public void testStaticTypingForClass468() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
