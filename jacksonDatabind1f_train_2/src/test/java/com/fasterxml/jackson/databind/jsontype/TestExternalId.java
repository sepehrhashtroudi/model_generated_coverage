...
public void testImproperExternalIdSerialization34() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     assertEquals("{\"extType\":\"funk\",\"i\":3}", mapper.writeValueAsString(new FunkyExternalBean())); 
 } 


public void testWithNaturalScalar11835() throws Exception { 
...
public void testMultipleTypeIdsDeserialization191() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testIssue831192() throws Exception { 
...
public void testIssue798193() throws Exception { 
