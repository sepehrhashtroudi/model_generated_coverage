...
public void testJDK7SuppressionProperty120() throws IOException { 
     Exception exc = MAPPER.readValue("{\"suppressed\":[]}", IOException.class); 
     assertNotNull(exc); 
 } 


public void testWithNullMessage177() throws IOException { 
     final ObjectMapper mapper = new ObjectMapper(); 
...
public void testIOException178() throws IOException { 
...
public void testNoArgsException179() throws IOException { 
