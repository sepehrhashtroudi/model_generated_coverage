...
public void testPrivateUsingGlobals141() throws Exception { 
...
public void testMapperShortcutMethods142() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
...
public void testBasicSetup589() throws Exception { 
     ObjectMapper m = new ObjectMapper(); 
     VisibilityChecker<?> vc = m.getVisibilityChecker(); 
