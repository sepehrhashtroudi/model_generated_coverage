...
public void testJson339() throws Exception { 
...
public void testSimpleGetters433() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testSimpleSetters434() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     mapper.setPropertyNamingStrategy(new PrefixStrategy()); 
...
public void testPerClassAnnotation435() throws Exception { 
