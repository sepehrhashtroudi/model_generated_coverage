...
public void testEnumsWithJsonValueUsingMixin67() throws Exception { 
...
public void testSubclassedEnums110() throws Exception { 
     assertEquals("\"B\"", mapper.writeValueAsString(EnumWithSubClass.B)); 
 } 


public void testEnumSet394() throws Exception { 
...
public void testToStringEnumWithEnumMap482() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testEnumUsingToString504() throws Exception { 
     StringWriter sw = new StringWriter(); 
