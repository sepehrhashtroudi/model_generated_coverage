...
public void testBoolean43() throws Exception { 
...
public void testDouble81() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     double value = 3.04; 
...
public void testInt88() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
     int value = -90184; 
     JsonNode result = mapper.readTree(String.valueOf(value)); 
     assertTrue(result.isNumber()); 
...
public void testSimple89() throws Exception { 
...
public void testDecimalNode91() throws Exception { 
...
@SuppressWarnings("unused") 
 public void testMissingNode93() throws Exception { 
     String JSON = "[ { }, [ ] ]"; 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testNull174() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
...
public void testEOF288() throws Exception { 
...
public void testMultiple379() throws Exception { 
...
public void testLong479() throws Exception { 
     ObjectMapper mapper = new ObjectMapper(); 
