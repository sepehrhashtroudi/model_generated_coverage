...
public void testAppend254() throws IOException { 
...
public void testSimpleArray256() throws IOException { 
...
public void testWithJsonParserSequenceSimple257() throws IOException { 
     TokenBuffer buf = new TokenBuffer(null); 
     buf.writeStartArray(); 
...
public void testSimpleObject260() throws IOException { 
     TokenBuffer buf = new TokenBuffer(null); 
     assertTrue(buf.getOutputContext().inRoot()); 
...
public void testWithJSONSampleDoc262() throws Exception { 
