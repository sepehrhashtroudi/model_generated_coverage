...
public void testNullForPrimitives42() throws IOException { 
...
public void testLongToBoolean317() throws Exception { 
...
public void testCurrency345() throws IOException { 
     Currency usd = Currency.getInstance("USD"); 
     assertEquals(usd, new ObjectMapper().readValue(quote("USD"), Currency.class)); 
 } 


public void testRegexps346() throws IOException { 
...
public void testInetAddress347() throws IOException { 
...
public void testCharset348() throws Exception { 
     Charset UTF8 = Charset.forName("UTF-8"); 
     assertSame(UTF8, mapper.readValue(quote("UTF-8"), Charset.class)); 
 } 


public void testUntypedWithJsonArrays472() throws Exception { 
